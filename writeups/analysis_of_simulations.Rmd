...
**Bias in estimating `pi`** (thresholding method does not estimate `pi`):
...
The EM method is less biased than the thresholding method. Both have poor confidence interval coverage rate, likely due to a glitch in the code.